...
class I18n {
  ...
  static const Map<String, Map<String, String>> _strings = {
    ...
    'tr': {
      ...
      'compare.menuLabel': 'Karşılaştır',
      'compare.addToCompare': 'Karşılaştır',
      'compare.added': 'Karşılaştırmaya eklendi',
      'compare.removed': 'Karşılaştırmadan çıkarıldı',
      'compare.full': 'En fazla 4 mekan karşılaştırılabilir',
      'compare.empty': 'Sepetin boş',
      'compare.emptyDesc': 'Mekan detay sayfasında "Karşılaştır" butonuyla 2-4 mekan ekle',
      'compare.clear': 'Temizle',
      'compare.clearTitle': 'Sepeti Temizle',
      'compare.clearConfirm': 'Tüm karşılaştırma sepeti silinsin mi?',
      'compare.maxNote': 'En fazla 4 mekan karşılaştırılabilir',
      'compare.rating': 'Puan',
      'compare.featured': 'Öne Çıkan',
      'compare.gps': 'Konum',
      // Stats
      'stats.title': 'Gezi İstatistikleri',
      'stats.loginRequired': 'İstatistikler için giriş yap',
      'stats.byCategory': 'Kategori Dağılımı',
      'stats.highlights': 'Öne Çıkanlar',
      'stats.topCategory': 'En sevdiğin kategori',
      'stats.topCity': 'En çok ziyaret ettiğin şehir',
      'stats.viewWrapped': '🎁 Travixx Wrapped\'i Gör',
      // Wrapped
      'wrapped.title': 'Travixx Yılın!',
      'wrapped.subtitle': 'Bu yılki gezi hikayene bakalım',
      'wrapped.places.title': 'Farklı Mekan Ziyaret Ettin!',
      'wrapped.places.subtitle': 'Her biri yeni bir hikaye',
      'wrapped.visits.title': 'Toplam Ziyaret',
      'wrapped.visits.subtitle': 'Vay be, gezgin ruhsun!',
      'wrapped.topCategory.title': 'En sevdiğin tür bu oldu',
      'wrapped.badges.title': 'Rozet Kazandın',
      'wrapped.badges.subtitle': 'Sıradaki rozet seni bekliyor',
      'wrapped.thankYou.title': 'Teşekkürler Travixx Ailesi!',
      'wrapped.thankYou.subtitle': 'Yeni yıl, yeni keşifler için hazır mısın?',
      // Top Rated
    ...
    'en': {
      ...
      'compare.menuLabel': 'Compare',
      'compare.addToCompare': 'Compare',
      'compare.added': 'Added to comparison',
      'compare.removed': 'Removed from comparison',
      'compare.full': 'You can compare up to 4 places',
      'compare.empty': 'Basket is empty',
      'compare.emptyDesc': 'Add 2-4 places from the place detail screen',
      'compare.clear': 'Clear',
      'compare.clearTitle': 'Clear Basket',
      'compare.clearConfirm': 'Delete entire comparison basket?',
      'compare.maxNote': 'You can compare up to 4 places',
      'compare.rating': 'Rating',
      'compare.featured': 'Featured',
      'compare.gps': 'Location',
      'stats.title': 'Travel Stats',
      'stats.loginRequired': 'Sign in to see stats',
      'stats.byCategory': 'By Category',
      'stats.highlights': 'Highlights',
      'stats.topCategory': 'Your favorite category',
      'stats.topCity': 'Most visited city',
      'stats.viewWrapped': '🎁 See Your Travixx Wrapped',
      'wrapped.title': 'Your Travixx Year!',
      'wrapped.subtitle': 'Let\'s look at your travel story',
      'wrapped.places.title': 'Unique Places Visited!',
      'wrapped.places.subtitle': 'Each one a new story',
      'wrapped.visits.title': 'Total Visits',
      'wrapped.visits.subtitle': 'Wow, what a traveler!',
      'wrapped.topCategory.title': 'Your favorite type',
      'wrapped.badges.title': 'Badges Earned',
      'wrapped.badges.subtitle': 'Next badge awaits!',
      'wrapped.thankYou.title': 'Thanks Travixx Family!',
